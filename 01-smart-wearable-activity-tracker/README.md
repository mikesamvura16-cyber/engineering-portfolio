...
A finite-element mesh was generated to discretise the geometry and enable numerical analysis. Mesh development was used to balance solution accuracy and computational efficiency while ensuring that critical geometric features were adequately represented.

<p align="center">
  <img src="images/Case%20Botton%201st%20Mesh.png" width="700" alt="Enclosure Mesh">
  <br>
  <em>Finite element mesh generated for the structural enclosure analysis.</em>
</p>

### Thermal Assessment

Thermal simulation was performed to evaluate heat dissipation throughout the enclosure during operation and charging conditions. The analysis was used to assess the effectiveness of the passive thermal-management strategy and identify regions susceptible to temperature accumulation.
...
Displacement analysis was conducted to evaluate deformation under applied loading conditions and verify that the selected geometry could maintain functional integrity without excessive deflection.
...
Stress analysis was used to identify critical stress concentrations and evaluate structural performance under expected service loads. The results supported assessment of component durability and informed geometry refinement.

<p align="center">
  <img src="images/Male%20Link%20Von%20Mises.png" width="700" alt="Von Mises Stress">
  <br>
  <em>Von Mises stress distribution used to validate the Factor of Safety against material yield strength.</em>
</p>
